...
const [errmessage, seterrmessage] = useState("")
  ...
  let valid=yup.object().shape({
    email:yup.string().matches(/^.+@(gmail.com|yahoo.com)$/,"enter the correct email").required(),
  ...
  let formik =useFormik({
    initialValues:{
      ...
      onSubmit:(vals)=>{
        axios.post(`https://ecommerce.routemisr.com/api/v1/auth/forgotPasswords`,vals)
